...
export function parsePowerGenerator(
  powerGeneratorArr: Record<string, unknown>[]
) {
  return powerGeneratorArr.reduce((acc, powerGenerator) => {
    ...
    return acc;
  }, {} as Record<string, PowerGenerators>) as Record<string, PowerGenerators>;
}
